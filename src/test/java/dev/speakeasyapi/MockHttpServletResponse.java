 ...
 *
 * <p>
 * As of Spring Framework 5.0, this set of mocks is designed on a Servlet 4.0
 * baseline.
 *
...
public class MockHttpServletResponse implements HttpServletResponse {
    ...
    public MockHttpServletResponse(Instant baseTime) {
    ...
    private String getCookieHeader(Cookie cookie) {
        ...
        if (maxAge >= 0) {
            ...
            if (expires != null) {
                ...
                headers.setExpires(maxAge > 0 ? this.baseTime.toEpochMilli() + 1000L * maxAge : 0);
